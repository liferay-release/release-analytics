...
# Loads SonarQube violation and complexity data into fact_file_complexity
#
# Input:  staging/raw_sonarqube_combined.rds
# Output: fact_file_complexity (PostgreSQL)
#         staging/transformed_complexity.rds
#
# Notes:
#   - Excludes test files and generated classes
#   - Cyclomatic/cognitive complexity only available for top 500 churn files
#   - Remaining files scored on violations only
# =============================================================================
